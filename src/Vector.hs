...
scaleVec :: Num a => Double -> Vector a -> Vector a
scaleVec v s = Vector (s * getX v) (s * getY v) (s * getZ v)

dotVec :: Num a => Vector a -> Vector a -> Double
